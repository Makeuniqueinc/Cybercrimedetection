<%-- 
    Document   : DataCleaning
    Created on : Dec 27, 2022, 11:05:06 PM
    Author     : Murthi
--%>
...
<html lang="en">
    ...
    <script>alert('Symbols removed Successfully');</script>  
    <%}
    %>
    ...
    <body>
        ...
        <div class="contact_srction layout_padding">
            <div class="container">
                <h1 class="contact_taital">Pre-Processing</h1>
                <br>
                <br>
                <br>
                <center><a href="stopwords" class="btn btn-danger">Remove Stop words</a></center>
                <br>
                <br>
                <br>
                    ...
                    <table>
                        ...
                        <tbody class="scroll-pane">
                            <%
                                ...
                                try {
                                    ResultSet rs = st.executeQuery("Select * from dataclean");
                                    while (rs.next()) {
                            %>
                            <tr>

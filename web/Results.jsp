<%-- 
    Document   : Results
    Created on : Dec 28, 2022, 10:28:09 AM
    Author     : Murthi
--%>
...
<html lang="en">
    ...
    <script>alert('Detection and Analysis Completed');</script>  
    <%}
    %>
    ...
    <body>
        ...
        <div class="contact_srction layout_padding">
            <div class="container">
                <h1 class="contact_taital">Racism Detection Analysis</h1>
                <br>
                <br>
                <br>
                    ...
                    <table>
                        <thead>
                            <tr>
                                <th>ID</th>
                                <th>Tweet Text</th>
                                <th>getSentimentScore</th>
                                <th>getSentimentType</th>
                                <th>getVeryPositive</th>
                                <th>getPositive</th>
                                <th>getNeutral</th>
                                <th>getNegative</th>
                                <th>getVeryNegative</th>
                                <th>Annotation</th>
                                <th>Label</th>
                            </tr>
                        </thead> 
                        <tbody class="scroll-pane">
                            <%
                                ...
                                try {
                                    ResultSet rs = st.executeQuery("Select * from senanalysisdetections");
                                    while (rs.next()) {
                            %>
                            <tr>
                                <td ><%=rs.getString("id")%></td>
                                <td  ><%=rs.getString("tweet")%></td>
                                <td  ><%=rs.getString("getSentimentScore")%></td>
                                <td  ><%=rs.getString("getSentimentType")%></td>
                                <td  ><%=rs.getString("getVeryPositive")%>%</td>
                                <td  ><%=rs.getString("getPositive")%>%</td>
                                <td  ><%=rs.getString("getNeutral")%>%</td>
                                <td  ><%=rs.getString("getNegative")%>%</td>
                                <td  ><%=rs.getString("getVeryNegative")%>%</td>

<%-- 
    Document   : Detection
    Created on : Dec 28, 2022, 7:56:45 AM
    Author     : Murthi
--%>
...
<html lang="en">
    ...
    <script>alert('Stopwords removed and Pre-Processing Completed');</script>  
    <%}
    %>
    <body>
        ...
        <div class="contact_srction layout_padding">
            <div class="container">
                <h1 class="contact_taital">Cleaned Dataset </h1>
                <br>
                <br>
                <br>
                <center><a href="SenAnalysisDection" class="btn btn-danger">Start Analysis</a></center>
                <br>
                <br>
                <br>
                    ...
                    <table>
                        ...
                        <tbody class="scroll-pane">
                            <%
                                ...
                                try {
                                    ResultSet rs = st.executeQuery("Select * from stopremoved");
                                    while (rs.next()) {
                            %>
                            <tr>
